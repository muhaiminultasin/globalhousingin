            ...
            <div className="container">
                ...
                <div className="row row-gutter-y-40">
                    ...
                    <div className="department-card">
                        ...
                        <h5>
                            <Link to="/community-partners">Your Community & Local Partners </Link>
                        </h5>
                        </div>
                    ...
                    <div className="department-card">
                        ...
                        <div className="department-card-content">
                        <h5>
                            <Link to="/workforce-development">Jobs & Workforce Development </Link>
                        </h5>
                        </div>
                    ...
                    <div className="department-card">
                        ...
                        <div className="department-card-content">
                        <h5>
                            <Link to="/infrastructure">Infrastructure & Housing Access </Link>
                        </h5>
                        </div>
                    ...
                    <div className="department-card">
                        ...
                        <div className="department-card-content">
                        <h5>
                            <Link to="/culture-community">Culture, Community & Resilience </Link>
                        </h5>
                        </div>
