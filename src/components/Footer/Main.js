            ...
            <div className="row">
              <div className="col-lg-4">
                <div className="footer-widget-logo">
                  <Link to="/">
                    <img src={Logo} className="img-fluid" alt="img-25" width={100}/>
                  </Link>
                </div>

                <div className="footer-widget-text">
                  <p>
                    Empowering communities through innovative, resilient housing
                    solutions that blend technology, sustainability, and social
                    impact worldwide.
                  </p>
                </div>
                ...
                <div className="footer-widget">
                  ...
                  <div className="footer-widget-contact-list">
                    ...
                    <div className="footer-widget-contact-item">
                      <Link
                        to="mailto: contact@globalhousinginitiative.org 
"
                      >
                        {" "}
