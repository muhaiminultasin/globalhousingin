          ...
          <div className="row">
              ...
              <div className="sidebar">
                ...
                <div className="sidebar-widget sidebar-widget-card">
                  ...
                  <div className="sidebar-widget-card-content">
                    ...
                    <p>
                      There are many variations of passages of lorem ipsum is
                      simply free text available in the marke.
                    </p>
                  </div>
                </div>
            ...
            <div className="col-lg-8">
              ...
              <div className="department-details-content-box">
                ...
                <p>
                  Everyone deserves a safe place to live. Our systems are
                  engineered to withstand earthquakes, wildfires, and floods,
                  prioritizing safety for vulnerable populations. GHI advances
                  housing justice by creating long-term, resilient solutions for
                  those most at risk.
                </p>
              </div>
