            ...
            <div className="col-lg-8">
              ...
              <div className="department-details-content-box">
                <h4 className="department-details-title">
                  Reshaping Housing with Innovation
                </h4>
                <p>
                  GHI is redefining the housing industry through NeoPOLYGON
                  Technology—an engineered system of modular, disaster-resilient
                  buildings. We partner with forward-thinking manufacturers,
                  developers, and investors to scale sustainable housing
                  solutions globally.
                </p>
              </div>
