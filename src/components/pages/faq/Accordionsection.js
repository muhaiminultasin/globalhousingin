...
function Accordionsection() {
  ...
  const groupedFAQs = [
    {
      category: "About GHI & Our Services",
      items: [
        {
          id: 1,
          title: "What is the Global Housing Initiative (GHI)?",
    ...
    {
      category: "Urban Village Initiative",
      items: [
        {
          id: 4,
          title: "What is the Urban Village Initiative?",
    ...
    {
      category: "Rebuilding Lives Program (RLP)",
      items: [
        {
          id: 7,
          title: "What is the Rebuilding Lives Program?",
    ...
    {
      category: "Community Investment Fund (CIF)",
      items: [
        {
          id: 9,
          title: "What is the Community Investment Fund?",
    ...
    {
      category: "PolyFRAME System & Construction",
      items: [
        {
          id: 12,
          title: "What is the PolyFRAME system?",
        ...
        <div className="row">
          ...
          <div className="col-lg-8">
            ...
            <section className="faq-section">
              ...
              <div className="faq-container">
                <h1 className="section-title">Frequently Asked Questions – Global Housing Initiative (GHI)</h1>
              <p>
                <i>Empowering communities through resilient design and purpose-driven development</i>
              </p>
                {groupedFAQs.map((group, index) => (
                  <div key={index} className="faq-category">
                    <h3 className="faq-category-title">{group.category}</h3>
                    <div className="faq-list" style={{ paddingBottom: "60px",}}>
                      {group.items.map(({ id, title, ans }) => (
                        <Accordion
                          key={id}
                          ques={title}
                          ans={ans}
