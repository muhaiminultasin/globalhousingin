...
import Team01 from '../../../assets/image/member1.jpg';
import Team02 from '../../../assets/image/member2.jpg';
import Team03 from '../../../assets/image/member3.jpg';
import Team04 from '../../../assets/image/member4.jpg';
            ...
            <div className="container">
                ...
                <div className="col-12 col-md-6 col-xl-3">
                    ...
                    <div className="team-card-content">
                        <h4>
                        <Link to="/teamdetails">Carlos Mendes</Link>
                        </h4>
                        <p>Director of Global Programs</p>
                    </div>
                ...
                <div className="col-12 col-md-6 col-xl-3">
                    ...
                    <div className="team-card-content">
                        <h4>
                        <Link to="/teamdetails">Sophia Zhang</Link>
                        </h4>
                ...
                <div className="col-12 col-md-6 col-xl-3">
                    ...
                    <div className="team-card-content">
                        <h4>
                        <Link to="/teamdetails">Grace Mbatha</Link>
                        </h4>
                        <p>Housing Architect Planner</p>
                    </div>
