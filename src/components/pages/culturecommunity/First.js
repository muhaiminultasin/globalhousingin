          ...
          <div className="row">
            ...
            <div className="col-lg-8">
              ...
              <div className="department-details-content-box">
                ...
                <p>
                  We believe housing is more than shelter—it’s the foundation of
                  thriving, inclusive communities. Our Urban Village model
                  respects cultural identity, supports families, and fosters
                  dignity through shared spaces, art, gardens, and local voices.
                </p>
              </div>
