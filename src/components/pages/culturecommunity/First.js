              ...
              <div className="row">
                ...
                <div className="col-lg-8">
                  ...
                  <div className="department-details-content-box">
                    <h4 className="department-details-title">Rooted in Culture. Built for Community.

</h4>
                    <p>
                      We believe housing is more than shelter—it’s the foundation of thriving, inclusive communities. Our Urban Village model respects cultural identity, supports families, and fosters dignity through shared spaces, art, gardens, and local voices.
